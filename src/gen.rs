...
//   let rt = Trg::Ptr(rt);
//   let (rtx, rty) = {
//     let loc = net.heap.alloc();
//     let n = Ptr::new(Ctr, 0, loc);
//     net.half_safe_link(rt, n);
//     (Trg::Ptr(n.p1()), Trg::Ptr(n.p2()))
//   };
//   let (rtyx, rtyy) = {
//     let loc = net.heap.alloc();
//     let n = Ptr::new(Ctr, 0, loc);
//     net.half_safe_link(rty, n);
//     (Trg::Ptr(n.p1()), Trg::Ptr(n.p2()))
//   };
//   net.half_safe_link(rtyx, Ptr::ERA);
//   let (rtyyx, rtyyy) = {
//     let loc = net.heap.alloc();
//     let n = Ptr::new(Ctr, 0, loc);
//     net.half_safe_link(rtyy, n);
//     (Trg::Ptr(n.p1()), Trg::Ptr(n.p2()))
//   };
//   let (rtyyxx, rtyyxy) = {
//     let lab = 0;
//     let ptr = rtyyx.target();
//     let loc = net.heap.alloc();
//     let n = Ptr::new(Ctr, lab, loc);
//     net.half_safe_link(rtyyx, n);
//     (Trg::Ptr(n.p1()), Trg::Ptr(n.p2()))
//   };
//   net.safe_link(rtx, rtyyxx);
//   let (rtyyyx, rtyyyy) = {
