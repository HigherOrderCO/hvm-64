...
//           code.push_str(&format!(
//             "{}let {} = Trg::Dir(Ptr::new(VR1, 0, got.loc()));\n",
//             ident(tab + 1),
//             num.show()
//           ));
//           code.push_str(&format!(
//             "{}let {} = Trg::Dir(Ptr::new(VR2, 0, got.loc()));\n",
//             ident(tab + 1),
//             res.show()
//           ));
//           code.push_str(&format!(
...
//           code.push_str(&format!("{}let {} = self.alloc(1);\n", ident(tab + 1), cse));
//           code.push_str(&format!(
//             "{}self.heap.set({}, P1, Ptr::new(MAT, 0, {}));\n",
//             ident(tab + 1),
//             lam,
//             mat
//           ));
//           code.push_str(&format!(
//             "{}self.heap.set({}, P2, Ptr::new(VR2, 0, {}));\n",
//             ident(tab + 1),
//             lam,
//             mat
//           ));
//           code.push_str(&format!(
//             "{}self.heap.set({}, P1, Ptr::new(LAM, 0, {}));\n",
//             ident(tab + 1),
//             mat,
//             cse
//           ));
